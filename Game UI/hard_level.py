...
class SpaceInvaders:
    def __init__(self):
        ...
        self.enemy_img1 = pygame.image.load("img/alien551.gif").convert_alpha()
    ...
    def initialize_game_settings(self):
        ...
        # Wave settings
        self.wave_number = 0
        self.enemy_count_increase_per_wave = 7
        self.initial_enemy_count = 20
        self.spawn_delay = 0.5
        self.spawn_delay_decrease_per_wave = 0.3
        ...
        self.boss_laser_duration = 1000  # Laser visible for 3000 milliseconds (including warning)
        self.warning_duration = 750  # Warning visible for 2000 milliseconds
        self.laser_size = random.choice([x for x in range(50,200)])

        # Health Bar settings
        self.BOSS_HEALTH_BAR_WIDTH = 50
        self.BOSS_HEALTH_BAR_HEIGHT = 200 
        self.BOSS_HEALTH_BAR_X = 100  # Distance from the left side of the screen
        self.BOSS_HEALTH_BAR_Y = 900  # Distance from the top of the screen
    ...
    def spawn_enemy(self):
        if not self.boss_active:
            ...
            enemy = {
                ...
                'y': random.randint(00, 300),  # Random Y within the upper part of the screen
                'dx': random.choice([-self.enemy_speed, self.enemy_speed]),
                'dy': self.enemy_speed,
                'type': enemy_type
            }
    ...
    def reset_wave(self):
        ...
        if self.wave_number % self.bwave == 0:
            self.boss_health = 100 + (self.wave_number // 10 * 5)
